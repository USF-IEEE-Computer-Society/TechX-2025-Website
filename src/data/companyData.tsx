...
export const companiesData: Company[] = [
  ...
  },
  {
    ...
    description:
      'Explore Your Future with Verizon at TechX Florida 2025! We invite you to visit our booth and connect with the Verizon team. This is your chance to learn about dynamic career paths, discuss innovative work, and discover how you can make a real impact with us through internships and job opportunities.',
  },
  {
    name: 'Tampa Devs',
    logo: tampadevsImg,
    ...
    description:
      'Tampa Devs is a fast-growing nonprofit community for software developers in the Tampa Bay area. <br /> Mission: Break barriers in the tech industry and create unique opportunities for the local community to learn, grow, and succeed together.',
  },
  {
    ...
    description:
      'ISACA focuses on the fields of IT audit and assurance, information and cyber security, governance, risk management, compliance, privacy, and emerging technologies. They serve both individuals and organizations by providing a world-class ecosystem of support, which includes:',
  },
  {
    name: 'Couchbase',
    logo: CouchBaseImg,
  ...
  },
  {
    ...
    description:
      'Uber AI Solutions is a new freelance marketplace at Uber connecting skilled earners to the growing demand of AI.',
  },
]
