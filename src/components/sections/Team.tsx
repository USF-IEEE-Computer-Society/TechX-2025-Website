    ...
    <div id="Team" className={'w-full h-auto bg-[#F5F5F5]'}>
      <div className={'w-full flex flex-col justify-center items-center gap-3'}>
        ...
        <p className={'w-[90%] text-md md:text-2xl text-ellipsis text-gray-600 text-center text-pretty'}>
          {' '}
          The minds behind TechX Florida 2025{' '}
        </p>

        <p
          className={
            'w-[90%] text-md md:text-2xl font-semibold text-ellipsis text-gray-600 text-center text-pretty mt-4'
          }
        >
      ...
      <p
        className={
          'w-full text-md md:text-2xl font-semibold text-ellipsis text-gray-600 text-center justify-center text-pretty mt-4'
        }
      >
        {' '}
        Professionals{' '}
