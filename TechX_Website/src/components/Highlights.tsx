...
export default function Highlights(){
    ...
    return (
        <div id='Events' className={"w-screen h-auto bg-white"}>
            ...
            <div className={"w-full h-full mt-4 gap-[2rem] pb-[2rem] justify-items-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-[1rem] lg:pt-[4rem]"}>

                <div className={"w-[80%] md:w-[90%] lg:w-[90%] xl:w-[90%] h-[50vh] xl:h-[55vh] flex flex-col rounded-xl shadow-2xl"}>
